...
use nanai_gna::gna_rs::gna_lib::kernels::KernelArguments;
use nanai_gna::gna_rs::gna_lib::kernels::*;
...
fn affine_sse4_process_copies_data() {
    ...
    let args = KernelArguments {
        input: BaseAddress::from_ptr(src.as_mut_ptr() as *mut u8),
        output: BaseAddress::from_ptr(dst.as_mut_ptr() as *mut u8),
        aux: None,
        width: 4,
        height: 1,
    };
