...
- `cargo run --example request_state --manifest-path gna-rs/Cargo.toml` — demonstrates `Gna2RequestEnqueue`, `Gna2RequestGetState`, `Gna2RequestIsInFlight`, and instrumentation result retrieval in the Rust skeleton.
